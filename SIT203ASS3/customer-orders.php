...
<body>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                            ...
                                            while(oci_fetch_array($stmt)) {
                                                ...
                                                {
                                                    $id[$i]=$temp;
                                                    $time[$i]=oci_result($stmt,"SHOPPINGTIME");
                                                    $price=oci_result($stmt,"PRICE");
                                                    $discounts=oci_result($stmt,"DISCOUNT");
                                                    $amount=oci_result($stmt,"AMOUNT");
                                                    $all=$amount*($price-$discounts);
                                                    $total[$temp]=$all;
                                                    $delivery[$temp]=oci_result($stmt,"DELIVERY");
                                                    $i++;
                                                }
                                                else
                                                {
                                            ...
                                            {
                                                $current_id=$id[$k];
                                                $gst=$total[$current_id]/10;
                                                $total[$current_id]=$total[$current_id]+$gst;
                                                $delivery_cost=0;
                                                if($delivery[$current_id]=='POST')
                                                {
                                                    if($total[$current_id]>=500)
                                                        $delivery_cost=0;
                                                    else
                                                        $delivery_cost=10;
                                                }
                                                else if($delivery[$current_id]=='EXPRESS')
                                                {
                                                    if($total[$current_id]>=500)
                                                        $delivery_cost=0;
                                                    else
                                                ...
                                                $total[$current_id]+=$delivery_cost;
                                            }
                                            oci_close($db);
                                            for($j=0;$j<$i;$j++)
                                            {
                                        ...
                                        <td><a href="customer-order.php?id='.$id[$j].'" class="btn btn-primary btn-sm">View</a>
                                        </td>
                                    </tr>';
                                            }
 ...
 _________________________________________________________ -->
    ...
    <script>function jump_to_result()
        {
