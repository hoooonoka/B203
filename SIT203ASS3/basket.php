...
//     echo '<script>window.location.href="basket-none.php";</script>';
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-md-9" id="basket">
                    ...
                    <div class="box">
                        ...
                        <form method="post" action="checkout1.php">
                            ...
                            <h1>Shopping cart</h1>
                            <p class="text-muted" id='ci'>You currently have <?php echo $i;?> item(s) in your cart.</p>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <td>
                                                <a href='{$url[$j]}'>
                                                    <img src='$path[$j]' alt='item'>
                                                </a>
                                            </td>
                                            <td><a href='$url[$j]'>".$name[$j]."</a>
                                            </td>
                                            <td>
                                                <input type='number' value='$number[$j]' class='form-control' onchange='update_price(this.id,this.value)' id='".$name[$j]."'>
                                            </td>
                                            <td id='".$name[$j]."_price'>$".$price[$j]."</td>
                                            <td id='".$name[$j]."_discounts'>$".$discounts[$j]."</td>
                                            <td id='".$name[$j]."_total'>$".$total[$j]."</td>
                                            <td><a id='0".$name[$j]."' onclick='delete_item(this.id)'><i class='fa fa-trash-o'></i></a>
                                            </td>
                                        </tr>";
                                            $all+=$total[$j];
                                            }
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th colspan="2" id='total_1'><?php echo '$'.$all;?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-default" href="basket.php"><i class="fa fa-refresh"></i> Update basket</a>
                                    <?php
                                    if($i==0)
                                        echo '<button type="submit" class="btn btn-primary" disabled id="next">Proceed to checkout <i class="fa fa-chevron-right"></i>
                                    </button>';
                                    else
                                        echo '<button type="submit" class="btn btn-primary" id="next">Proceed to checkout <i class="fa fa-chevron-right"></i>
                                    </button>';
                                    ?>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>GST 10%</td>
                                        <th id='gst'><?php $gst=$all/10;echo '$'.$gst;?></th>
                                    </tr>
                                    <tr class="total">
                                        <td>Total</td>
                                        <th id='all_gst'><?php $all+=$gst;echo '$'.$all;?></th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            xmlhttp.onreadystatechange=function()
            {
                if (xmlhttp.readyState==4 && xmlhttp.status==200)
                {
                    if(xmlhttp.responseText!='')//success
                    {
                        ...
                        var cn=xmlhttp.responseText.substr(0,1);
                        cn=parseInt(cn);
                        document.getElementById('ci').innerHTML='You currently have '+cn+' item(s) in your cart.';
                    }
                    // else
                        // document.getElementById('old_pass_error').innerHTML='wrong password, please type it again';
                }
