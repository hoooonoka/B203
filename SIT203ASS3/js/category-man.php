...
<body onload="start()">
                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- <form> --><!--remove form, commented by wu, 17/7/2017-->
                                <div class="form-group"><!--add id for checkboxes and labels, commented by wu, 17/7/2017-->
                                    <div class="checkbox">
 ...
 _________________________________________________________ -->
    ...
    <!--import functions for this page, commented by wu, 17/7/2017-->
    <?php
if(!isset($_SESSION['signin']))
...
?>
    <!--function used in this page, commented by wu, 17/7/2017-->
    <script type="text/javascript">
        ...
        function start()
        {
            ...
            if(location.indexOf('?')!=-1&&location.indexOf('=')!=-1)
            {
                ...
                generate_page(xmlDoc,6,'Men',null);
        }
