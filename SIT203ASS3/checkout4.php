...
if($_POST['payment']=='payment2')
{
    $_SESSION['payment']='card';
    $_SESSION['cardname']=htmlentities($_POST['cardname']);
    $_SESSION['cardnumber']=htmlentities($_POST['cardnumber']);
    $_SESSION['expirymonth']=htmlentities($_POST['expirymonth']);
    $_SESSION['expiryyear']=htmlentities($_POST['expiryyear']);
    $_SESSION['cvv']=htmlentities($_POST['cvv']);
}
else
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>$<?php echo $_SESSION['delivery_cost'];?></th>
                                    </tr>
                                    <tr>
                                        <td>GST 10%</td>
                                    ...
                                    <tr class="total">
                                        <td>Total</td>
                                        <th>$<?php $final=$gst+$all+$_SESSION['delivery_cost']; echo $final;?></th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
