                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if($have_edited==true)
                                            echo '<input type="text" class="form-control" id="firstname" value="'.$firstname.'" name="firstname" onchange="informationValidation(this.id,this.value)" required>';
                                        else
                                            echo '<input type="text" class="form-control" id="firstname" name="firstname" onchange="informationValidation(this.id,this.value)" required>';
                                        ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if($have_edited==true)
                                            echo '<input type="text" class="form-control" id="lastname" value="'.$lastname.'" name="lastname" onchange="informationValidation(this.id,this.value)" required>';
                                        else
                                            echo '<input type="text" class="form-control" id="lastname" name="lastname" onchange="informationValidation(this.id,this.value)" required>';
                                        ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if(isset($_SESSION['email']))
                                        echo '<input type="text" class="form-control" id="email" value="'.$_SESSION['email'].'" name="email" onchange="informationValidation(this.id,this.value)" required>';
                                        else
                                        echo '<input type="text" class="form-control" id="email" name="email" onchange="informationValidation(this.id,this.value)" required>';    
                                        ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="subject" required onchange="check()">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="message">Message</label>
                                        <textarea id="message" class="form-control" required onchange="check()"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group" >
                                        captcha: <input type="text" name="captcha" required  onchange="check_captcha(this.value)" id="captcha"/>
                                ...
                                <div class="col-sm-12 text-center">
                                    <button type="submit" class="btn btn-primary" disabled id="continue"><i class="fa fa-envelope-o"></i> Send message</button>
 ...
 _________________________________________________________ -->
    ...
    <script>
        function validation()
        {
            ...
            if(document.getElementById('captcha_error').innerHTML!=''||document.getElementById('captcha').value=='')
            {
                return false;
            }
            return true;
        ...
        function check_captcha(value)
        {
            ...
            xmlhttp.onreadystatechange=function()
            {
                if (xmlhttp.readyState==4 && xmlhttp.status==200)
                {
                    ...
                    {
                        document.getElementById('captcha_error').innerHTML='false captcha';
                        document.getElementById('continue').disabled=true;
                    }
                }
                
            }
            xmlhttp.open( 'POST', 'check_captcha.php', true );
            xmlhttp.setRequestHeader( 'Content-Type', 'application/x-www-form-urlencoded' );
