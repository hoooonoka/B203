...
<body onload="start()">
 ...
 _________________________________________________________ -->
    <div id="top"><!--add id for div, commented by wu, 17/7/2017-->
        <div class="container">
 ...
 _________________________________________________________ -->
                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Brands <a class="btn btn-xs btn-danger pull-right" href="javascript:selection_clear()"><i class="fa fa-times-circle"></i> Clear</a></h3>
                        </div>

                        <div class="panel-body">

                            <!-- <form> --><!--remove form, commented by wu, 17/7/2017-->
                                <div class="form-group"><!--add id for labels and checkboxes, commented by wu, 17/7/2017-->
                                    <div class="checkbox">
 ...
 _________________________________________________________ -->
    ...
    <!--functions need to be imported for this page, commented by wu, 17/7/2017-->
    <?php
if(!isset($_SESSION['signin']))
...
?>
    <!--functions used in this page, commented by wu, 17/7/2017-->
    <script type="text/javascript">
        ...
        function start()
        {
            ...
            if(location.indexOf('?')!=-1&&location.indexOf('=')!=-1)
            {
                ...
                generate_page(xmlDoc,6,'Lady',null);
        }
