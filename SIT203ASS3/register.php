...
<body>
            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <p class="text-center">
                                <button class="btn btn-primary" onclick="check_password_original()"><i class="fa fa-sign-in"></i> Log in</button>
                            </p>
                    ...
                    <div class="box">
                        ...
                        <form action="create_new_user.php" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="rname" name='name' onchange="check_total()">
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="text" class="form-control" id="remail" name='email' onchange="check_email()">
                                <p id='rerror' style="color: red"></p>
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" class="form-control" id="rpassword" name='password' onchange="check_total()">
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary" disabled id='registerbtn'><i class="fa fa-user-md"></i> Register</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <hr>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary" onclick="check_password()"><i class="fa fa-sign-in"></i> Log in</button>
                            </div>
                    </div>
                </div>
 ...
 _________________________________________________________ -->
    ...
    <script type="text/javascript">
        function check_email()
        {
            ...
            xmlhttp.onreadystatechange=function()
            {
                if (xmlhttp.readyState==4 && xmlhttp.status==200)
                {
                    ...
                    {
                        document.getElementById('rerror').innerHTML='email exist, please change another one';
                        check_total();
                    }
                }
            }
            xmlhttp.open( 'POST', 'check_email_exist.php', true );
        ...
        function check_password()
        {
            ...
            xmlhttp.onreadystatechange=function()
            {
                if (xmlhttp.readyState==4 && xmlhttp.status==200)
                {
                    ...
                    {
                        document.getElementById('lerror').innerHTML='email or password wrong, please check your email and password again';
                    }
                }
            }
        ...
        function check_password_original()
        {
        ...
        {
            if(document.getElementById('rname').value!=''&&document.getElementById('remail').value!=''&&document.getElementById('rpassword').value!=''&&document.getElementById('rerror').innerHTML=='')
